...
class PaymentsApi(object):
    ...
    def mpesa_c2b_v2_registerurl_post(self, body, **kwargs):  # noqa: E501
        """Register C2B Confirmation and Validation URLs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mpesa_c2b_v2_registerurl_post(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.mpesa_c2b_v2_registerurl_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.mpesa_c2b_v2_registerurl_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def mpesa_c2b_v2_registerurl_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """Register C2B Confirmation and Validation URLs  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.mpesa_c2b_v2_registerurl_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method mpesa_c2b_v2_registerurl_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `mpesa_c2b_v2_registerurl_post`")  # noqa: E501
