...
class B2CPaymentRequest(object):
    ...
    def __init__(self, originator_conversation_id=None, initiator_name=None, security_credential=None, command_id=None, amount=None, party_a=None, party_b=None, remarks=None, queue_time_out_url=None, result_url=None, occasion=None):  # noqa: E501
    ...
    def originator_conversation_id(self):
        """Gets the originator_conversation_id of this B2CPaymentRequest.  # noqa: E501

        This is a unique string you specify for every API request you simulate. If not provided, the system may generate one automatically.  # noqa: E501

        :return: The originator_conversation_id of this B2CPaymentRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def originator_conversation_id(self, originator_conversation_id):
        """Sets the originator_conversation_id of this B2CPaymentRequest.

        This is a unique string you specify for every API request you simulate. If not provided, the system may generate one automatically.  # noqa: E501

        :param originator_conversation_id: The originator_conversation_id of this B2CPaymentRequest.  # noqa: E501
        :type: str
        """
    ...
    def initiator_name(self):
        ...
        This is an API user created by the Business Administrator of the M-PESA Bulk disbursement account that is active and authorised to initiate B2C transactions via API.  # noqa: E501
    ...
    def security_credential(self):
        ...
        This is the value obtained after encrypting the API initiator password. The password on Sandbox has been provisioned on the simulator. However, on production the password is created when the user is being created on the M-PESA organisation portal.  # noqa: E501
    ...
    def command_id(self, command_id):
        ...
        allowed_values = ["SalaryPayment", "BusinessPayment", "PromotionPayment"]  # noqa: E501
    ...
    def amount(self):
        ...
        The amount of money being sent to the customer (whole numbers only).  # noqa: E501
    ...
    def party_a(self):
        ...
        This is the B2C organisation shortcode from which the money is sent from (5-7 digits).  # noqa: E501
    ...
    def queue_time_out_url(self):
        ...
        This is the URL to be specified in your request that will be used by API Proxy to send notification in case the payment request is timed out while awaiting processing in the queue. Optional - if not provided, no timeout notifications will be sent.  # noqa: E501
    ...
    def result_url(self):
        ...
        This is the URL to be specified in your request that will be used by M-PESA to send notification upon processing of the payment request. Optional - if not provided, no result notifications will be sent.  # noqa: E501
    ...
    def occasion(self):
        ...
        Any additional information to be associated with the transaction (optional).  # noqa: E501
